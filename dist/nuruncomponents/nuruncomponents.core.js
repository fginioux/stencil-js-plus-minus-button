...
((w,d,x,n,h,c,r)=>{((s)=>{s&&(r=s.getAttribute('data-resources-url'))})(d.querySelector("script[data-namespace='nuruncomponents']"));
/**
 * SSR Attribute Names
 */
...
})(window,document,{},"NurunComponents","hydrated",[["plus-minus-button-component","plus-minus-button-component",1,[["border",1,0,1,8],["desc",1,0,1,2],["getCount",32],["host",64],["max",1,0,1,8],["min",1,0,1,8]],1]]);